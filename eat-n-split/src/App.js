...
const initialFriends = [
  {
    // if the balance number a negative its mean you own your friend
    // and if the balance number a posotive its mean your friend own you .
    id: 118836,
    name: "Clark",
...
export default function App() {
  ...
  function handleDeleteFriend(friend) {
    ...
    if (friend.balance !== 0) {
      alert("First, you need to settle your debts together.");
    } else {
      setSelectedFriend(null);
      setShowAddFriend(false);
      setTimeout(() => {
        alert(`you delete " ${friend.name} " from split List`);
      }, 0);
    }
  }
  ...
  return (
    <>
      <h1 style={{ marginBottom: "30px", fontSize: "38px", fontWeight: "500" }}>
        Eat and{" "}
        <span style={{ color: "#4881ea", fontWeight: "800" }}>Split</span> with
        your friends
      </h1>
      <div className="app">
